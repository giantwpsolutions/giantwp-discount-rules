...
<template>
  <div class="space-y-4 max-w-64 mb-5">
    ...
    <div class="flex items-center gap-2 mt-6 mb-1">
      <el-switch v-model="enableUsage" inline-prompt :active-text="__( 'On', 'aio-woodiscount')" :inactive-text="__( 'Off', 'aio-woodiscount')" />
      <label class="text-sm font-medium text-gray-900 flex items-center gap-1">
        ...
        <div class="group relative">
          ...
          class="box-item"
          effect="dark"
          :content="__('The maximum usage of this coupon. Once the discount rule is applied in the completed order, it is counted as a discount use.', 'aio-woodiscount') "
          placement="top"
