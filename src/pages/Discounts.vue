...
const discountRules = ref([
  { id: 1, name: 'COUPON123', type: 'BOGO', startDate: '2024-12-01', endDate: '2024-12-31', status: true },
  { id: 2, name: 'SUMMER2024', type: 'Percentage', startDate: '2024-06-01', endDate: '2024-09-01', status: false },
]);
...
<template>
  <div class="bg-white rounded-[10px] min-h-[250px] border border-gray-300 p-6">
    <h3 class="text-xl font-bold mb-6">{{ __('Discount Rules', 'aio-woodiscount') }}</h3>
    ...
    <!-- Modal Component -->
    <AddRuleModal v-if="showModal" @close="closeModal" />
  </div>
</template>
