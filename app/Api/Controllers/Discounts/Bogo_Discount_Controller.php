...
use GiantWP_Discount_Rules\Helper\Sanitization\Bogo_Sanitization_Helper;
...
class Bogo_Discount_Controller extends WP_REST_Controller {
    ...
    public function save_form_data( WP_REST_Request $request ) {
        ...
        $existing_data = get_option( 'giantwp_bogo_discount', [] );
        ...
        // Save to Database
        $saved = update_option( 'giantwp_bogo_discount', maybe_serialize( $existing_data ) );
    ...
    public function update_discount( WP_REST_Request $request ) {
        ...
        if ( $updated ) {
            update_option( 'giantwp_bogo_discount', maybe_serialize( $existing_data ) );
    ...
    public function delete_discount( WP_REST_Request $request ) {
        ...
        return new WP_REST_Response( [ 'success' => true, 'message' => __( 'Data deleted successfully.', 'giantwp-discount-rules' ) ], 200);
    }
