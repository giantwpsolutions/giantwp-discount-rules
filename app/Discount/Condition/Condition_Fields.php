...
class Condition_Fields {
    ...
    public static function cart_subtotal_price( $cart_items, $condition ) {
        ...
        return gwp_compare_numaric_value( $subtotal, $comparation, $value );
    }
    ...
    public static function cart_quantity( $cart_items, $condition ) {
        ...
        return gwp_compare_numaric_value( $quantity, $condition['operator'], $condition['value'] );
    }
    ...
    public static function cart_total_weight( $cart_items, $condition ) {
        ...
        return gwp_compare_numaric_value( $total_weight, $comparation, $value );
    }
    ...
    public static function cart_item_regular_price( $cart_items, $condition ) {
        ...
        foreach ( $cart_items as $item ) {
            ...
            if ( gwp_compare_numaric_value( $regular_price, $operator, $value ) ) {
                return true;
            }
        }
        return false;
    ...
    public static function cart_item_product( $cart_items, $condition ) {
        ...
        return gwp_compare_cart_items( $product_ids_in_cart, $operator, $condition_ids );
    }
    ...
    public static function cart_item_variation( $cart_items, $condition ) {
        ...
        return gwp_compare_cart_items( $variation_ids_in_cart, $operator, $condition_ids );
    }
    ...
    public static function cart_item_category( $cart_items, $condition ) {
        ...
        return gwp_compare_cart_items( $cart_category_ids, $operator, $condition_ids );
    }
    ...
    public static function cart_item_tag( $cart_items, $condition ) {
        ...
        return gwp_compare_cart_items( $tag_ids_in_cart, $operator, $condition_ids );
    }
    ...
    public static function customer_order_count( $cart_items, $condition ) {
        ...
        return gwp_compare_numaric_value( $order_count, $operator, $value );
    }
    ...
    public static function customer_order_history_product( $cart_items, $condition ) {
        ...
        return gwp_compare_cart_items( $purchased_product_ids, $operator, $condition_ids );
    }
    ...
    public static function customer_order_history_category( $cart_items, $condition ) {
        ...
        return gwp_compare_cart_items( $ordered_cat_ids, $operator, $condition_ids );
    }
    ...
    public static function payment_method( $cart_items, $condition ) {
        ...
        $chosen_method = WC()->session->get( 'chosen_payment_method' ) ?: WC()->session->get( 'gwp_selected_payment_method' );

        if ( empty( $chosen_method ) ) {
            return false;
        }

        return gwp_compare_list( $chosen_method, $operator, $expected_methods );
    }
    ...
    public static function customer_role( $cart_items, $condition ) {
        ...
        return gwp_compare_list( $user_roles, $condition['operator'], $condition['value'] );
    }
    ...
    public static function specific_customer( $cart_items, $condition ) {
        ...
        return gwp_compare_list( $current_user_id, $condition['operator'], $condition['value'] );
    }
}
